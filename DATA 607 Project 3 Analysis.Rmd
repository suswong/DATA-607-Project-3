...
general <- c("(?i)Statistical analysis","(?i)data analysis","(?i)Machine Learning","(?i)data visual","(?i)wrangling","(?i)mathematics","(?i)programming","(?i)statistics","(?i)big data","(?i)Artificial intelligence","(?i)Deep learning")
